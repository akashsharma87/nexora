...
import { Check, ChevronDown, ChevronRight, Loader2, Plus, RefreshCw, Sheet, Trash2, X } from 'lucide-react'
    ...
    <DashboardLayout>
      <div className="px-4 py-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-white">Lead Integrations</h1>
