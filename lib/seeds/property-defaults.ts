  ...
  const platforms = [
    {
      ...
      contentChecklist: [
        { item: 'Profile created with hotel name and description', done: false },
        { item: 'Minimum 20 banquet photos uploaded', done: false },
        { item: 'Pricing packages listed (per-plate + rental)', done: false },
        { item: 'Capacity range set (min/max guests)', done: false },
        { item: 'Amenities and facilities listed', done: false },
        { item: 'Inquiry routing email configured', done: false },
        { item: 'Reviews section active', done: false },
        { item: 'Location and map pinned correctly', done: false },
        { item: 'Contact number verified', done: false },
        { item: 'Availability calendar updated', done: false },
      ],
    },
    {
      ...
      contentChecklist: [
        { item: 'Venue registered on Weddingz.in', done: false },
        { item: 'Banquet hall photos uploaded (min 15)', done: false },
        { item: 'Package pricing added', done: false },
        { item: 'Vendor marketplace integrations added', done: false },
        { item: 'Destination wedding category enabled', done: false },
        { item: 'Inquiry email and phone verified', done: false },
        { item: 'Testimonials/reviews section filled', done: false },
        { item: 'Location and area correctly tagged', done: false },
        { item: 'Capacity details complete', done: false },
        { item: 'Response time under 2 hours configured', done: false },
      ],
    },
    {
      ...
      contentChecklist: [
        { item: 'Venue profile created on VenueLook', done: false },
        { item: 'All event type categories selected', done: false },
        { item: 'Photos uploaded (min 10)', done: false },
        { item: 'Free quote enabled', done: false },
        { item: 'Pricing range indicated', done: false },
        { item: 'City and locality correctly tagged', done: false },
        { item: 'Capacity and layout options listed', done: false },
        { item: 'Amenities checklist completed', done: false },
        { item: 'Contact details verified', done: false },
        { item: 'Parking and accessibility info added', done: false },
      ],
    },
    {
      ...
      contentChecklist: [
        { item: 'Verified listing application submitted', done: false },
        { item: 'Account manager assigned', done: false },
        { item: 'Profile description written', done: false },
        { item: 'Gallery photos uploaded', done: false },
        { item: 'Pricing tiers configured', done: false },
        { item: 'Reviews solicited from past clients', done: false },
        { item: 'Pan-India visibility settings enabled', done: false },
        { item: 'Contact routing confirmed', done: false },
        { item: 'Monthly analytics report set up', done: false },
        { item: 'Seasonal offers created', done: false },
      ],
    },
    {
      ...
      contentChecklist: [
        { item: 'Google Business Profile claimed and verified', done: false },
        { item: 'Business category set to "Banquet Hall"', done: false },
        { item: 'Address and map pin verified', done: false },
        { item: 'Phone number added and verified', done: false },
        { item: 'Business hours set correctly', done: false },
        { item: 'Min 25 photos uploaded (interior + exterior)', done: false },
        { item: 'Services section filled (weddings, corporate, etc.)', done: false },
        { item: 'Respond to all existing reviews', done: false },
        { item: 'Posts section activated (1 post/week minimum)', done: false },
        { item: 'Q&A section monitored and answered', done: false },
      ],
    },
    {
      ...
      contentChecklist: [
        { item: 'JustDial listing claimed or created', done: false },
        { item: 'Business category correctly set', done: false },
        { item: 'Phone number(s) added', done: false },
        { item: 'Service area and city configured', done: false },
        { item: 'Photos added to listing', done: false },
        { item: 'Verified badge applied for', done: false },
        { item: 'Corporate event category enabled', done: false },
        { item: 'Pricing range indicated', done: false },
        { item: 'Reviews requested from past clients', done: false },
        { item: 'Call tracking number set up', done: false },
      ],
    },
  ]
